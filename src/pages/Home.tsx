...
import { BookOpen, Calendar, CheckSquare, TrendingUp, User, Sparkles, LogOut, Moon, Sun } from "lucide-react";
  ...
  return <div className="min-h-screen bg-gradient-subtle">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        y: 0
          ...
          <h2 className="text-3xl font-bold font-serif mb-2">Welcome back, {profile?.name || profile?.username || user?.email}!</h2>
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          return <motion.div key={index} variants={item}>
                <Card className="group cursor-pointer hover:shadow-strong transition-all duration-300 border-0 overflow-hidden h-full" onClick={() => navigate(module.path)}>
